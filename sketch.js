...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("--Space Fighters--",canvas.width/2-300,canvas.height/2-300);
    ...
    text("  save the people and Earth !",canvas.width/2-300,canvas.height/2-130);
    ...
    text("  press 'w' to start game.",canvas.width/2,canvas.height/2-10);
